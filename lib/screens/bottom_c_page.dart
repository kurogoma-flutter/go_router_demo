...
class _TabBarNavigationScreenState extends State<TabBarNavigationScreen>
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('BottomC Navigation'),
          bottom: TabBar(
            ...
            Align(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () => context.push('/additional'),
                    child: const Text('GO TO ADDITIONAL'),
                  ),
                ],
              ),
            ),
