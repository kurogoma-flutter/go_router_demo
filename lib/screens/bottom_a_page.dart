...
///
class BottomANavigationScreen extends ConsumerWidget {
  const BottomANavigationScreen({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('BottomA Navigation'),
        ),
        body: SafeArea(
          child: Center(
            child: Stack(
